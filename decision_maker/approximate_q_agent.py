...
class ApproxQAgent(InfiniteRTAgent):
    ...
    def benders_decomposition_train(self,
        ...
        upper_bound, info = self.coefficient_model.solve(init_solution=init_solution, is_hard_bound=True, max_iter=1500, parallel=parallel, verbose=verbose, checkpoint_path=checkpoint_path, resume_checkpoint_path=resume_checkpoint_path, min_norm_action=True, purge_after=purge_after)
