...
class InfiniteRTAgent:
    ...
    def get_state_var_fast(self, model):
        self.state_var_counter += 1
    ...
    def get_action_var_fast(self, model, advance_scheduling_type):
        self.action_var_counter += 1
    ...
    def get_next_state_fast(self, model, state, action, new_arrival):
        ...
        next_state_var = self.get_state_var_fast(model=model)
    ...
    def add_action_space_constraints_fast(self, model, state_var, action_var):
        regular_booking_vars, overtime_booking_vars, waitlist_vars = state_var
        advance_scheduling_decision_vars, overtime_decision_vars = action_var
